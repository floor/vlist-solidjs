  ...
  globalThis.ResizeObserver = class {
    ...
    observe(target: Element): void {
      this.cb([{
        ...
        // A real ResizeObserverEntry carries both, and autosize() measures the
        // border box. Without this the shim crashes it.
...
describe("createVList — render", () => {
  ...
  it("#119: accepts and runs a plugins array overlapping auto-wiring", async () => {
    ...
    // which declares a conflict with autosize — a combination vlist refuses by
    // design, and beside the point of #119.)
...
it("forwards a typed synthetic factory and creates the synthetic driver", async () => {
  ...
  // resolves to a plugin, which is what proves the primitive forwards them.
